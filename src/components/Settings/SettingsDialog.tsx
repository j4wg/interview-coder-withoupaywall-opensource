        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-white/60 -mt-1">
              Choose whether to process coding problems or general interview
              questions
            </p>
            <div className="flex gap-2">
              <div
                ...
                onClick={() => setQuestionMode("coding")}
              >
                <div className="flex items-center gap-2">
                  <div
                    className={`w-3 h-3 rounded-full ${
                      questionMode === "coding" ? "bg-white" : "bg-white/20"
                    }`}
                  />
                  <div>
                    <p className="font-medium text-white text-xs">Coding</p>
                    <p className="text-xs text-white/60">
                      Algorithmic problems with code solutions
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2">
                  <div
                    className={`w-3 h-3 rounded-full ${
                      questionMode === "general" ? "bg-white" : "bg-white/20"
                    }`}
                  />
                  <div>
                    <p className="font-medium text-white text-xs">General</p>
                    <p className="text-xs text-white/60">
